def test_functional_add_category__unauthorised(client):
    """
...
def test_functional_add_category__no_period(client_logged_in_user):
    """
...
def test_functional_add_category__is_period(client_with_period):
    """
...
def test_functional_add_category__is_category(client_logged_in_user):
    """
...
def test_functional_add_category__is_transaction(client_with_transactions):
    """
