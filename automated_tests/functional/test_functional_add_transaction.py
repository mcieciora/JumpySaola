def test_functional_add_transaction__unauthorised(client):
    """
...
def test_functional_add_transaction__registered(client_with_period):
    """
...
def test_functional_add_transaction__no_category(client_with_transactions):
    """
...
def test_functional_add_transaction__no_period(client_with_categories):
    """
...
def test_functional_add_transaction__is_transaction(client_with_transactions):
    """
