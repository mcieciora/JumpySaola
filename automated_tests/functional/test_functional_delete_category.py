def test_functional_delete_category__unauthorised(client):
    """
...
def test_functional_delete_category__registered(client_with_categories):
    """
...
def test_functional_delete_category__no_period(client_with_categories):
    """
...
def test_functional_delete_category__is_period(client_with_period):
    """
...
def test_functional_delete_category__no_category(client_logged_in_user):
    """
...
def test_functional_delete_category__is_transaction(client_with_transactions):
    """
