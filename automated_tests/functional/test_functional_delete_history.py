def test_functional_delete_history__unauthorised(client):
    """
...
def test_functional_delete_category__registered(client_with_history):
    """
...
def test_functional_delete_history__no_history(client_without_history):
    """
