def test_functional_delete_transaction__unauthorised(client):
    """
...
def test_functional_delete_transaction__registered(client_with_transactions):
    """
...
def test_functional_delete_transaction__no_transaction(client_with_period):
    """
