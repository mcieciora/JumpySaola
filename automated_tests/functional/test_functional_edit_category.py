def test_functional_edit_category__unauthorised(logger, client_with_categories):
    """
...
def test_functional_edit_category__no_period(logger, client_with_categories):
    """
...
def test_functional_edit_category__is_period(logger, client_with_period):
    """
...
def test_functional_edit_category__is_category(logger, client_with_categories):
    """
...
def test_functional_edit_category__is_transaction(logger, client_with_transactions):
    """
