def test_functional_login__unregistered(logger, client):
    """
        Covers: T-REQ1
    """
...
def test_functional_login__unauthorised(logger, client_users_setup):
    """
...
def test_functional_login__logged_in(logger, client_logged_in_user):
    """
        Covers: T-REQ4
    """
