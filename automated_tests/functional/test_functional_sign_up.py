def test_functional_sing_up__unregistered(client):
    """
...
def test_functional_sing_up__unauthorised(client_users_setup):
    """
...
def test_functional_sing_up__logged_in(client_logged_in_user):
    """
        Covers: T-REQ12
    """
