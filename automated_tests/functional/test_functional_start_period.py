def test_functional_start_period__unauthorised(logger, client):
    """
...
def test_functional_start_period__registered(logger, client_with_categories):
    """
...
def test_functional_start_period__no_category(logger, client_logged_in_user):
    """
...
def test_functional_start_period__is_period(logger, client_with_period):
    """
...
def test_functional_start_period__is_transaction(logger, client_with_transactions):
    """
