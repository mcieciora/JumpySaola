...
def test_transaction_add__non_logged_user_transaction_add(client):
    response = client.post('/', data=dict(transaction_value='25', transaction_desc='shopping', transaction_category='category',
...
def test_transaction_delete__delete_transaction(client_with_transactions):
    response = client_with_transactions.post('/delete_transaction/1')
    assert response.status_code == 200, f'Expected response status code: 200, actual: {response.status_code}'
...
def test_transaction_add__no_category_transaction_add(client_with_transactions):
